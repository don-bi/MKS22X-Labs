/**IMPORTANT:
  ...
  void setup() {
     ...
     *ANSWER HERE:The ratio of width to cols and height to rows must be the same.
     */
  ...
  void draw() {
     ...
     *ANSWER HERE: What the framecount is being remaindered by is the delay between each interval of the tree simulator ticking.
     */
